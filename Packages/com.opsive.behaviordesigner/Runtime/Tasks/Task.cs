...
namespace Opsive.BehaviorDesigner.Runtime.Tasks
{
    ...
    public abstract class Task : ISavableTask
    {
        ...
        protected virtual bool ReceiveDrawGizmosCallback => false; // Will be removed after add-on pack update. TODO.
        protected virtual bool ReceiveDrawGizmosSelectedCallback => false; // Will be removed after add-on pack update. TODO.
