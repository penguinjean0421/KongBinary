...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.Physics
{
    ...
    /// <summary>
    /// Returns success when the agent enters a trigger. This task will only receive the physics callback if it is being reevaluated (with a conditional abort or under a parallel task).
    /// </summary>
